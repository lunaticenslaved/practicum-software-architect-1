...
В этом разделе приведён предлагаемый способ реализации системы c использованием микросервисной архитектуры.
...
- [Документация API микросервиса аутентификации и авторизации](docs/openapi/auth-service.yaml)
- [Документация API микросервиса управления домами](docs/openapi/home-service.yaml)
- [Документация API микросервиса сенсоров](docs/openapi/sensors-service.yaml)
- [Документация API микросервиса телеметрии](docs/openapi/telemetry-service.yaml)
...
На текущем этапе:
- будут добавлены два новых микросервиса: сервис управления сенсорами и сервис сбора телеметрии;
- эти сервисы будут интегрированы в текущее монолитное решение.
