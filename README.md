 nb      n# Задание 1. Анализ и планирование
...
![Диаграмма компонентов ClimateControlService](./schemas/component/ClimateControlService_Component.png)
![Диаграмма компонентов HomeManagmentService](./schemas/component/HomeManagmentService_Component.png)
![Диаграмма компонентов UserService](./schemas/component/UserService_Component.png)

**Диаграмма кода (Code)**

![Диаграмма кода](./schemas/code/ClimateControl_ServiceLayer_Code.png)
